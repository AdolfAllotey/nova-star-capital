...
def compute_risk_state(analysis_dir: Path, telemetry_dir: Path) -> Dict[str, Any]:
    ...
    # Components debug
    components.append({"name": "market_conditions", "score": round(mc_score, 2), "weight": 0.40})
    components.append({"name": "coherence", "score": round(coh_score, 2), "weight": 0.25})
