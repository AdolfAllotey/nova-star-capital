...
def run(data_dir: Optional[str] = None) -> None:
    ...
    existing = kill_switch.get("enriched", {}).get("existing", kill_switch)
    ...
    stats = {
        ...
        "nb_executed_simulated": nb_executed_simulated,
        ...
        if isinstance(plan_obj, dict) and (not plan_obj.get("orders")) and fills:
            ...
            for f in fills:
                ...
                derived_orders.append({
                    ...
                    "order_type": "weight",
                    "requested_weight": f.get("requested_weight"),
                    "weight": f.get("filled_weight") if f.get("filled_weight") is not None else f.get("requested_weight"),
                    ...
                    "source": "derived_from_simulated_fills",
                })
